                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.plantowatch:
                                ParseQuery<ParseObject> plan_to_watch_query = ParseQuery.getQuery("Koppel");
                                plan_to_watch_query.whereEqualTo("User", ParseUser.getCurrentUser().getUsername());
                                plan_to_watch_query.whereEqualTo("Serie", Title.getText());
                                    ...
                                    public void done(List<ParseObject> User, com.parse.ParseException p) {
                                        if (p == null) {
                                            try {
                                                ...
                                                koppel.put("User", ParseUser.getCurrentUser().getUsername());
                                                koppel.put("Serie", Title.getText());
                                                koppel.put("Status", "Plan to watch");
                                                koppel.saveInBackground();
                                            }
                                        }
